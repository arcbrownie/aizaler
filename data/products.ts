...
export const PRODUCTS: Product[] = [
  {
    ...
    badge: 'BEST',
    category: '실전 그로스 바이블',
    title: '메타 추천 알고리즘의 냉혹한 실전 법칙: 20만 뷰의 저주와 First 9의 과학',
    tagline: '실측 423만 뷰와 DB 결제 로그 전수 분석으로 규명한 소셜 알고리즘 엔지니어링 바이블',
    description: '조회수 20만이 터졌는데 왜 유료 결제는 4건뿐이었을까요? 뜬구름 잡는 마케팅 이론을 찢고, 실제 695편 포스트 전수 데이터와 PostgreSQL DB 로그를 대조해 밝혀낸 메타 DLRM 추천 알고리즘의 작동 원리와 1,000~3,000뷰 스위트 스팟, 그리고 계정 셧다운 시 되살리는 3단계 회복 프로토콜을 집대성했습니다.',
    originalPrice: 129000,
    discountRate: 62,
    salePrice: 49000,
    monthlyPrice: 'PDF 140p + 계정 진단 스크립트 제공',
    features: [
      '20.7만 뷰 참사 복기와 DLRM 추천 엔진 작동 원리 해부',
      '695편 전수 분석: CVR 4.49% 황금 스위트 스팟 데이터 리포트',
      'First 9 텍스트 임베딩(Sentence-BERT)과 프로필 3초 전환 공식',
      '계정 건강 자동 진단 도구(threads-health.ts) 소스코드 제공'
    ],
    target: '조회수만 터지고 실제 매출이 안 나와 답답한 1인 창업가, 퍼포먼스 마케터, 인디해커',
    highlightProof: '사내 3개 프로덕트 423만 뷰 실측 및 695편 전수 DB 로그 기반 검증',
    accentColor: '#3182f6',
  },
  {
    id: '2',
    ...
    badge: 'FREE',
    category: '무료 리포트 & SQL',
    title: '메타 알고리즘 Two-Tower 오염 진단 SQL 쿼리북 & First 9 체크리스트',
    tagline: '내 계정의 알고리즘 건강 상태와 결제 전환율을 Neon DB 쿼리로 즉시 검증하는 무료 리드 마그넷',
    description: '내 글이 왜 스킵당하는지, 어떤 글이 계정에 독이 든 쿠키인지 감으로 짐작하지 마세요. 실제 PostgreSQL / Neon DB에서 조회수 대비 유료 결제 전환율을 측정하는 실전 SQL 쿼리 10선과 프로필 상단 9개 피드 벡터 순도 점검 체크리스트를 100% 무료 배포합니다.',
    originalPrice: 39000,
    discountRate: 100,
    salePrice: 0,
    ...
    features: [
      ...
      'DLRM 후보군 오염 및 알고리즘 숙취 자가진단 프로토콜',
  ...
  },
  {
    ...
    badge: 'HOT',
    category: '실전 그로스 바이블',
    title: '메타 광고(Meta Ads) 소오름 매칭 플레이북: 증거물 앵글로 결제 CVR 8.6% 뽑아내는 법',
    tagline: '광고 장면과 랜딩 첫 카드의 1:1 회수로 유입 누수를 막고 결제를 극대화하는 퍼포먼스 바이블',
    description: '궁금증 앵글은 유입만 모으고(결제 0.8%), 증거물 앵글은 결제를 만듭니다(결제 8.6%). 광고 소재에서 보여준 구체적 장면이 랜딩페이지 첫 문장에서 1:1로 회수되지 않으면 전환율은 0%로 추락합니다. 14일간의 실측 데이터로 증명된 UTM 소오름 매칭 설계도와 CAPI 전환 추적 노하우를 전수합니다.',
    originalPrice: 159000,
    discountRate: 56,
    salePrice: 69000,
    monthlyPrice: '실전 캠페인 세팅 시트 포함',
    features: [
      '궁금증(0.8%) vs 증거물(8.6%) 14일 실측 A/B 데이터 분석서',
      '소재 대문구 ↔ 랜딩 첫 화면 1:1 일치 소오름 매칭 프레임워크',
    ...
    highlightProof: '사내 버티컬 서비스 실제 메타 광고 결제 전환율 8.6% 달성',
    accentColor: '#8b5cf6',
  },
  {
    id: '4',
