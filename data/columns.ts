...
export const COLUMNS: Column[] = [
  ...
  },
  {
    ...
    title: '비나인 매조키즘(Benign Masochism): 왜 인간은 ‘유쾌한 팩트 폭격’과 약점 지적에 기꺼이 돈을 쓰는가?',
    excerpt: '롤러코스터를 타고 매운 떡볶이를 먹듯, 인간은 "안전하게 위협받는 경험"에서 깊은 쾌락과 전환을 느낍니다. "당신의 이 업무 습관 때문에 매달 돈과 시간이 샌다", "현지인 앞에서 그 영어 표현 쓰면 갑분싸 난다"처럼 고객의 뼈를 안전하게 때리는 카피가 어떻게 20% 결제 전환율로 이어지는지 심리 기전을 해부합니다.',
    readTime: '9분 읽기',
    date: '2026. 09. 10',
    category: '소셜 심리 공학',
    views: 13200,
