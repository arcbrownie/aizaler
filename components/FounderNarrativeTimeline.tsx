...
const TIMELINE_STEPS: TimelineStep[] = [
  ...
  },
  {
    ...
    description: '인터넷 강의에서 말하는 "AI로 자동 수익"은 거짓이었습니다. 직접 웹 서비스를 만들고, 매달 내 생돈으로 메타 광고비와 서버비를 태우며 쓰라린 실패를 연달아 맞았습니다. 스레드에서 20.7만 조회수 대박 글이 터졌으나 결제는 고작 4건(0.0019%)뿐이었고, 엉뚱한 구경꾼만 대거 유입되어 계정이 5일간 노출 -92%로 급락하는 역주행을 겪었습니다. 하루 10개 글을 난사했다가 계정이 48시간 셧다운당하기도 했습니다.',
    metrics: [
  ...
  },
  {
    ...
    subtitle: 'Meta Certified Media Planning Professional 취득, 스레드 2개 계정 합산 500만 뷰 DB 분석과 광고 ↔ 랜딩 1:1 일치로 결제율 8.6% 달성',
    quote: '"실패에 울지 않고, 메타 공식 자격을 파고들고 코드를 뜯어고쳤습니다."',
    description: '실패에 좌절하는 대신, 메타 공식 자격인 "Meta Certified Media Planning Professional(메타 공인 미디어 플래닝 전문가)"을 취득하며 메타 광고 추천 시스템의 알고리즘을 바닥부터 파고들었습니다. 695편의 포스트와 스레드 2개 계정(명사도 본계정 + 연애 계정) 합산 누적 500만 뷰 결제 데이터베이스를 전수 대조해 "진짜 결제 고객이 들어오는 1,000~3,000뷰의 황금 스위트 스팟"을 찾아냈고, 광고 장면과 랜딩 첫 카드를 1초 만에 1:1로 일치시키는 공식으로 결제 전환율 8.6%를 달성했습니다.',
    metrics: [
      { label: '메타 공식 자격', value: 'Media Planning Pro' },
      { label: '전수 분석 데이터', value: '스레드 500만 뷰 · 695편' },
