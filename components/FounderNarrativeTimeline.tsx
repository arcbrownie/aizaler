...
const TIMELINE_STEPS: TimelineStep[] = [
  ...
  },
  {
    ...
    description: '실패에 좌절하는 대신, 메타 공식 자격인 "Meta Certified Media Planning Professional(메타 공인 미디어 플래닝 전문가)"을 취득하며 메타 광고 추천 시스템의 알고리즘을 바닥부터 파고들었습니다. 695편의 포스트와 스레드 2개 버티컬 계정 합산 누적 500만 뷰 결제 데이터베이스를 전수 대조해 "진짜 결제 고객이 들어오는 1,000~3,000뷰의 황금 스위트 스팟"을 찾아냈고, 광고 장면과 랜딩 첫 카드를 1초 만에 1:1로 일치시키는 공식으로 결제 전환율 8.6%를 달성했습니다.',
    metrics: [
