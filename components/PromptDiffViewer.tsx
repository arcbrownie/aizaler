...
const CASES: PromptCase[] = [
  ...
  },
  {
    ...
    afterPrompt: '[Meta 공인 전문가의 광고 퍼널 & 알고리즘 진단 프롬프트]\n입력값: 릴스 207,709뷰 / 결제 4건 (CVR 0.0019%)\n분석 요구:\n1) 메타 추천 머신러닝이 왜 비구매 구경꾼 군집으로 왜곡되었는지 원인 진단\n2) 향후 7일간 피드 타겟 순도를 복구하고 결제 전환율을 살리는 3단계 즉시 처방전',
    afterResult: '✓ 추천 알고리즘이 저품질 밈 반응자로 왜곡된 메커니즘 규명\n✓ 7일 친밀도 반감기 기간 동안 코어 전문 텍스트 100% 강제 주입 전략\n✓ 2주 차 타겟 CVR 2.8%로 정상 반등 퍼널 파이프라인 완성!',
